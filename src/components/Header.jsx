...
<Link to={"/"}>
          ...
          <div className="hidden md:flex items-center gap-5">
            <Link className="text-black text-lg font-semibold hover:border-b hover:text-red-500" to={"/"}>Home</Link>
            <Link className="text-black text-lg font-semibold hover:border-b hover:text-red-500" to={"/contact"}>Contact</Link>
            <Link className="text-black text-lg font-semibold hover:border-b hover:text-red-500" to={"/about"}>About</Link>
            <Link className="text-black text-lg font-semibold hover:border-b hover:text-red-500" to={"/signup"}>Sign Up</Link>
          </div>
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <Link onClick={() => setOpen(false)} className="text-black text-base font-semibold py-1" to={"/"}>Home</Link>
            <Link onClick={() => setOpen(false)} className="text-black text-base font-semibold py-1" to={"/contact"}>Contact</Link>
            <Link onClick={() => setOpen(false)} className="text-black text-base font-semibold py-1" to={"/about"}>About</Link>
            <Link onClick={() => setOpen(false)} className="text-black text-base font-semibold py-1" to={"/signup"}>Sign Up</Link>
          </div>
        </div>
      </div>
    </header>
